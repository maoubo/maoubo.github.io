...
My passion for RL originated from my love of puzzle games, which sparked my fascination with sequential decision-making processes. Over time, I observed that while most researchers prioritize improving the performance of RL algorithms across various tasks, there is comparatively less focus on addressing their security risks. This gap has motivated me to explore the potential vulnerabilities of RL from multiple perspectives and to develop solutions aimed at improving the safety and reliability of RL in real-world applications. Outside of academics, I’m a passionate basketball fan and enjoy comedy. Feel free to email me if you’d like to chat about either of these topics!
